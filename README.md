...
- 游戏数据结构参考: [xivapi/ffxiv-datamining](https://github.com/xivapi/ffxiv-datamining)
- 中文官方文本: [thewakingsands/ffxiv-datamining-cn](https://github.com/thewakingsands/ffxiv-datamining-cn)(卡拉工具组)
- 资料查证: [最终幻想XIV中文维基(灰机wiki)](https://ff14.huijiwiki.com)
- 游戏数据与官方图鉴文本版权 © SQUARE ENIX CO., LTD. 本项目为非商业玩家二创, 仅供学习交流, 与 SQUARE ENIX 无从属关系。

## 灵感来源

- 项目灵感：[tutusagi/ai-fishing-game](https://github.com/tutusagi/ai-fishing-game)
- 借鉴设计：每条返回末尾附 📊 状态栏、`;` 分号串联指令

## 反馈与免责

- 有 bug 或想法：欢迎在仓库 Issues 留言。**本项目按「现状(AS IS)」提供，不许诺修复或更新。**
- 想按自己口味改：随时 fork / 拷一份，MIT 协议随便改。
- 非官方粉丝作品，与 SQUARE ENIX 无关；FINAL FANTASY XIV 及相关名称、文本 © SQUARE ENIX，仅供学习交流，请勿商用。

## 数据来源

- 天气算法：社区 / SaintCoinach 通用实现，与游戏一致
- 天气概率表：xivapi/ffxiv-datamining（`WeatherRate` 等）
- 鱼 / 钓场 / 开窗条件：icykoneko/ff14-fish-tracker-app 的 `private/fishData.yaml`
- 食物 / 料理数据：灰机wiki (https://ff14.huijiwiki.com)